...
import { createCredentialType } from "./graphql/mutations";
const client = generateClient();
export default function CredentialTypeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCredentialType.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CredentialTypeCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
