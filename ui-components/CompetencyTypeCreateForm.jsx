...
import { createCompetencyType } from "./graphql/mutations";
const client = generateClient();
export default function CompetencyTypeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCompetencyType.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CompetencyTypeCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
