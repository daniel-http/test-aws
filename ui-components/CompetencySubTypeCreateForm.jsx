...
import { createCompetencySubType } from "./graphql/mutations";
const client = generateClient();
export default function CompetencySubTypeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCompetencySubType.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CompetencySubTypeCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
