...
export default function TrainingUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = trainingRecord
      ...
      : initialValues;
    setLookupId(cleanValues.lookupId);
    setDuration(cleanValues.duration);
    setStartDate(cleanValues.startDate);
    setSharedTraining(cleanValues.sharedTraining);
    setHasCorrectiveActionPlan(cleanValues.hasCorrectiveActionPlan);
    setHasSafetyPlan(cleanValues.hasSafetyPlan);
    setHasCredential(cleanValues.hasCredential);
    setHasReferralEmail(cleanValues.hasReferralEmail);
    setRequestedReason(cleanValues.requestedReason);
    setReportCardScore(cleanValues.reportCardScore);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          sharedTraining: sharedTraining ?? null,
          hasCorrectiveActionPlan: hasCorrectiveActionPlan ?? null,
          hasSafetyPlan: hasSafetyPlan ?? null,
          hasCredential: hasCredential ?? null,
          hasReferralEmail: hasReferralEmail ?? null,
          requestedReason: requestedReason ?? null,
          reportCardScore: reportCardScore ?? null,
