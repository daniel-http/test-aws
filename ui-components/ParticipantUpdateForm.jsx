...
export default function ParticipantUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = participantRecord
      ...
      : initialValues;
    setSearchId(cleanValues.searchId);
    setFirstName(cleanValues.firstName);
    setLastName(cleanValues.lastName);
    setEmail(cleanValues.email);
    setTnpalId(cleanValues.tnpalId);
    setFein(cleanValues.fein);
    setFeinExt(cleanValues.feinExt);
    setFacilityName(cleanValues.facilityName);
    setContactTime(cleanValues.contactTime);
    setPostalCode(cleanValues.postalCode);
    setCounty(cleanValues.county);
    setPosition(cleanValues.position);
    setCerticateIssued(cleanValues.certicateIssued);
    setFollowUpIssued(cleanValues.followUpIssued);
    setFollowUpMethod(cleanValues.followUpMethod);
    setFollowUpDate(cleanValues.followUpDate);
    setErrors({});
  };
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getParticipant.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getParticipant
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          lastName,
          email,
          tnpalId: tnpalId ?? null,
          fein: fein ?? null,
          feinExt: feinExt ?? null,
          facilityName,
          contactTime,
          postalCode,
          county: county ?? null,
          position: position ?? null,
          certicateIssued: certicateIssued ?? null,
          followUpIssued: followUpIssued ?? null,
        ...
        try {
          ...
          await client.graphql({
            query: updateParticipant.replaceAll("__typename", ""),
            variables: {
              input: {
